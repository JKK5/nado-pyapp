...
character_x_pos = (screen_width - character_width) / 2  # 화면 가로의 절반
...
enemy_x_pos = (screen_width - enemy_width) / 2  # 화면 가운데
enemy_y_pos = (screen_height - enemy_height) / 2  # 화면 가운데
...
while running:
    ...
    pygame.display.update()  # 매 프레임마다 다시 그리기
